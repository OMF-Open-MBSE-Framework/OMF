...
public class PortCreatedFromConnectionRule extends ARule {
    public Stereotype strInstance = null;

    private PortCreatedFromConnectionRule(String id) {
        super(id);
    }
    public PortCreatedFromConnectionRule(String id, Stereotype strInstance) {
        this.id = id;
