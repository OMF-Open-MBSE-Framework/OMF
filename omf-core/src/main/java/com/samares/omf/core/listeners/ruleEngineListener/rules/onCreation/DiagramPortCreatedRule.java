...
public class DiagramPortCreatedRule extends ARule {
    public Stereotype strToApply = null;
    public Stereotype strOwner   = null;

    private DiagramPortCreatedRule(String id) {
        super(id);
    }
    public DiagramPortCreatedRule(String id, Stereotype strToApply, Stereotype strOwner) {
        this.id         = id;
