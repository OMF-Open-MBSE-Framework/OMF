...
package com.samares.omf.core.utils.builders.sysml.directors;
...
import com.samares.omf.core.utils.builders.uml.PortBuilder;
...
import com.samares.omf.core.utils.builders.generic.IGenericBuilder;
import com.samares.omf.core.utils.builders.sysml.ConnectorBuilder;
import com.samares.omf.core.utils.builders.sysml.InterfaceBlockBuilder;
import com.samares.omf.core.utils.builders.sysml.ProxyPortBuilder;
...
//            l_connectors.add(createDirectConnection());
    ...
    public ConnectionDirector withRefresh() {
        InternalDiagramManagement.refreshAllConnectors(l_createdConnectors, OMFUtils.getOpenedDiagram());
        return this;
    }
