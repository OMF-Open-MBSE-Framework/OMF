...
public class FeatureHookExecutor extends HookExecutor<IFeatureLifeCycleHook> {
   ...
   public void triggerOnFeatureRegisteringHooks(MDFeature feature) {
       try {
           ...
           ErrorHandler2.getInstance().handleException(new HooksExecutionException("Error while triggering onFeatureRegistering hooks", e));
       }
    ...
    public void triggerOnFeatureUnregisteringHooks(MDFeature feature) {
        try {
            ...
            ErrorHandler2.getInstance().handleException(new HooksExecutionException("Error while triggering onFeatureUnregistering hooks", e));
        }
    }
