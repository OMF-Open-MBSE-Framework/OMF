 ...
 * @since     0.0.0
 ******************************************************************************/
package com.samares_engineering.omf.omf_core_framework.ui.actions.browser.debug;
...
public class DebugOnOffOptionsBrowser extends DefaultBrowserStateAction {
...
//    }
    ...
    public DebugOnOffOptionsBrowser(String name, Object optionInstance, Method optionSetterMethod, Method optionGetterMethod) {
        super("", "[Debug] option state: " + name, null, null);
        this.name = name;
    ...
    public void actionPerformed(ActionEvent e) {
        Runnable runnable = () -> {
            try {
                if (optionSetterFunction != null && optionGetterFunction != null)
