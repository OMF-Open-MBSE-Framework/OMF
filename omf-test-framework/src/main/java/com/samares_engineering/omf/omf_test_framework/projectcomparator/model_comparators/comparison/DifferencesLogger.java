...
public class DifferencesLogger {
    private final Set<com.samares_engineering.omf.omf_test_framework.projectcomparator.model_comparators.comparison.DifferencesLogger.Entry> added = new HashSet<>();
...
//    }
    ...
    public String getDiffInfo() {
        ...
        com.samares_engineering.omf.omf_test_framework.projectcomparator.model_comparators.comparison.DifferencesLogger.Entry entry;
        if (!getAdded().isEmpty()) {
            sBuilder.append("New elements:\n");

            for (com.samares_engineering.omf.omf_test_framework.projectcomparator.model_comparators.comparison.DifferencesLogger.Entry value : getAdded()) {
                entry = value;
                sBuilder.append("--- ");
        ...
        if (!getRemoved().isEmpty()) {
            ...
            for (com.samares_engineering.omf.omf_test_framework.projectcomparator.model_comparators.comparison.DifferencesLogger.Entry value : getRemoved()) {
                entry = value;
                sBuilder.append("--- ");
                ComparatorUtils.toFullName(entry.getElement(), sBuilder);
                sBuilder.append("property=");
        ...
        if (!getChanged().isEmpty()) {
            ...
            for (Map.Entry<Element, com.samares_engineering.omf.omf_test_framework.projectcomparator.model_comparators.comparison.DifferencesLogger.Diff> elementDiffEntry : getChanged().entrySet()) {
                sBuilder.append("--- ");
                ComparatorUtils.toFullName(elementDiffEntry.getKey(), sBuilder);
                sBuilder.append(":\n");
                com.samares_engineering.omf.omf_test_framework.projectcomparator.model_comparators.comparison.DifferencesLogger.Diff diff = elementDiffEntry.getValue();
    ...
    protected void addChange(Element owner1, Element owner2, Element elem1, Element elem2, String changeDesc) {
        com.samares_engineering.omf.omf_test_framework.projectcomparator.model_comparators.comparison.DifferencesLogger.Diff diff = changed.computeIfAbsent(elem1, elem1x -> new com.samares_engineering.omf.omf_test_framework.projectcomparator.model_comparators.comparison.DifferencesLogger.Diff(elem2));
    ...
    public Set<com.samares_engineering.omf.omf_test_framework.projectcomparator.model_comparators.comparison.DifferencesLogger.Entry> getAdded() {
        return added;
    }

    public Set<com.samares_engineering.omf.omf_test_framework.projectcomparator.model_comparators.comparison.DifferencesLogger.Entry> getRemoved() {
        return removed;
    }

    public Map<Element, com.samares_engineering.omf.omf_test_framework.projectcomparator.model_comparators.comparison.DifferencesLogger.Diff> getChanged() {
        return changed;
    }
}
