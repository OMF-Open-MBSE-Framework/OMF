...
package com.samares_engineering.omf.omf_example_plugin.features.customizationValidationFeature;
...
import com.samares_engineering.omf.omf_example_plugin.features.customizationValidationFeature.actions.CheckAllCustomization;
import com.samares_engineering.omf.omf_example_plugin.features.customizationValidationFeature.actions.PutAllCustomizationAttributeToStandard;
...
public class CustomizationValidationFeature extends AFeature {
    public CustomizationValidationFeature() {
        super( "CHECK CUSTOMIZATION");
    }
    ...
    public List<UIAction> initFeatureActions() {
        return List.of(
             new PutAllCustomizationAttributeToStandard(),
            new CheckAllCustomization()
        );
    }
