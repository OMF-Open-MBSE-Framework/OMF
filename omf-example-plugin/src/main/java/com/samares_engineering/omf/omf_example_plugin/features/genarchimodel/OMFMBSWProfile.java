...
public class OMFMBSWProfile extends ProfileImplementation
{
    ...
    private final FunctionStereotype functionStereotype;
    ...
    public  OMFMBSWProfile(ProfileCache cache)
    {
        ...
        functionStereotype = new FunctionStereotype(this);
    ...
    public FunctionStereotype function()
    {
        return functionStereotype;
    }
    ...
    public static class AnnotationStereotype extends StereotypeWrapper
    {
        ...
        {
            return _p.codeClass().getIsStaticProperty();
        }

        @CheckForNull
        public Property getPackageProperty()
        {
            return _p.codeClass().getPackageProperty();
        }

        @CheckForNull
        public Property getTypeProperty()
        {
            return _p.codeClass().getTypeProperty();
        }
        ...
        {
            _p.codeClass().clearIsStatic(element);
        }
        @CheckForNull
        public Boolean isIsStatic(Element element)
        {
            return _p.codeClass().isIsStatic(element);
        }
        public void setPackage(Element element, @CheckForNull String value)
        {
            Profiles.setValue(element, getStereotype(), getPackageProperty(), value);
        }
        public void clearPackage(Element element)
        {
            _p.codeClass().clearPackage(element);
        }
        @CheckForNull
        public String getPackage(Element element)
        {
            return _p.codeClass().getPackage(element);
        }
        ...
        {
            _p.codeClass().clearType(element);
        }
        @CheckForNull
        public ClassTypeEnum getType(Element element)
        {
            return _p.codeClass().getType(element);
        }
    ...
    public static class CodeClassStereotype extends StereotypeWrapper
    {
        ...
        public Property getPackageProperty()
        {
            if (_package == null)
            {
                _package = getTagByName(getStereotype(), PACKAGE);
            }
            return _package;
        }
        ...
        public void clearPackage(Element element)
        {
            Profiles.clearValue(element, getPackageProperty());
        }

        @CheckForNull
        public String getPackage(Element element)
        {
            return toString(Profiles.getFirstValue(element, getPackageProperty()));
        }
    ...
    public static class EnumClassStereotype extends StereotypeWrapper
    {
        ...
        {
            return (element instanceof com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class
                    || element instanceof com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Enumeration) &&
                    _p.isTypeOf(element, getStereotype());
        }
    ...
    public static class FeatureItemStereotype extends StereotypeWrapper
    {
        ...
        //stereotype FeatureI tem and its tags
        public static final String STEREOTYPE_NAME =  "FeatureI tem";
    ...
    public static class FunctionStereotype extends StereotypeWrapper
    {


        //stereotype Function and its tags
        ...
        @CheckForNull
        private Property isEncapsulated;
        protected  FunctionStereotype(OMFMBSWProfile profile)
        {
            super(profile);
            _p = profile;
        }
        ...
        public static boolean isInstance(@CheckForNull Element element)
        {
            ...
            {
                OMFMBSWProfile instance = getInstance(element);
                return instance.isTypeOf(element, instance.function().getStereotype());
            }
            return false;
        }
    ...
    protected Collection<ProfileElementWrapper> generatedGetAllElementWrappers()
    {
        ...
        wrappers.add(functionStereotype);
    ...
    protected Collection<Stereotype> generatedGetAllStereotypes()
    {
        if (getProfile() != null)
        {
            ...
            stereotypes.add(functionStereotype.getStereotype());
...
//MD5sum:5CBADD0DC2C223A41E7E17CC057E0096