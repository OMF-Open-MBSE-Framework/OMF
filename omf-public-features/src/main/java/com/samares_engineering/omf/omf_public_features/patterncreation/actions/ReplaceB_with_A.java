...
@BrowserAction
@DeactivateListener
@MDAction(actionName = "Replace B with A", category = "***PATTERNS")
public class ReplaceB_with_A extends AUIAction {
    @Override
    ...
    public void actionToPerform(List<Element> selectedElements) {
        try {
            Element elemA = selectedElements.get(1);
            Refactoring.Replacing.replace(elemA, selectedElements.get(0), new ConvertElementInfo(elemA.getClass()));
        } catch (Exception e) {
