...
public class CreationTestGenerator {
    ...
    private void addElementCreation(MethodSpec.Builder methodBuilder) {
        ...
        if (creationMethod.isEmpty()) {
           throw new OMFCriticalException2(new OMFLog2().text("Can't find a suitable creation method for the provided element").linkElement(testedElement.getName(), testedElement));
        }
